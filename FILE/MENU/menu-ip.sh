...
if [[ -f /etc/onexd77/github/api && -f /etc/onexd77/github/email && /etc/onexd77/github/username ]]; then
   rec="OK"
else
    mkdir /etc/onexd77/github > /dev/null 2>&1
fi
...
sleep 2
echo "$EMAIL1" > /etc/onexd77/github/email
echo "$USERNAME1" > /etc/onexd77/github/username
echo "$API1" > /etc/onexd77/github/api
echo "ON" > /etc/onexd77/github/gitstat
clear
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
...
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
GITREQ=/etc/onexd77/github/gitstat
if [ -f "$GITREQ" ]; then
    cekk="ok"
else 
    mkdir /etc/onexd77/github
    touch /etc/onexd77/github/gitstat
    echo "OFF" > /etc/onexd77/github/gitstat
fi

stst1=$(cat /etc/onexd77/github/gitstat)
if [ "$stst1" = "OFF" ]; then
clear
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
echo -e "$COLOR1 ${NC} ${COLBG1}               ${WH}• REGISTER IPVPS •              ${NC} $COLOR1 $NC"
...
stst=$(cat /etc/onexd77/github/gitstat)
if [ "$stst" = "ON" ]; then
APIOK="CEK API"
rex="viewapi"
else
